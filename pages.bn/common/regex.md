...
> নোট: `regex` কোনো কমান্ড নয়, বরং অন্যান্য কমান্ডের সাথে ব্যবহারের জন্য একটি সিনট্যাক্স।
...
- একটি ক্যারেক্টার সেটের যেকোনো একটি ক্যারেক্টার ম্যাচ করুন:
...
- একটি শব্দের সীমানা (boundary) ম্যাচ করুন:
